(function(){
  ...
  function install(){
    ...
    const box=document.createElement('nav');box.id='bhGovernanceEntry';box.className='bh-gov-entry';box.append(link('/control-center.html','مركز الرقابة'),link('/governance.html','الحوكمة والتسليم'),link('/cost-reports.html','تقارير التكلفة والربحية',true),link('/mix-designs.html','تكلفة الخلطات'),link('/device-access.html','ربط الجهاز'));document.body.appendChild(box);
  }
