...
(function(){
  ...
  function cancelCapture(reason){if(!captureRequest)return false;var active=captureRequest;captureRequest=null;active.reject(reason instanceof Error?reason:new Error(String(reason||'تم إلغاء تجهيز المستند.')));return true;}
