(function(){
  ...
  const VERSION='2026.07.23-owner-web-login-v9-non-dismissible-gate',USER_KEY='binhamid_cloud_app_user_id',TOKEN_KEY='binhamid_cloud_access_token',DEVICE_KEY='binhamid_cloud_device_id',REFRESH_INTERVAL=6*60*60*1000,SESSION_TIMEOUT=2500;
