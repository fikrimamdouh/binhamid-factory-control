(function(){
'use strict';
const VERSION='2026.07.22-admin-nav-v11-unified-master-workspace';
const LINKS=[
  ['🏠','البرنامج','/','التشغيل'],
...
function installPageExtensions(){ensureEmployeeTransfer();ensureAttendanceSitePresets();ensureAttendanceCanonicalEmployees();}
