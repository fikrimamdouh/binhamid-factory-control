...
if(currentVersion<28||currentVersion>targetVersion)fail('SCHEMA_VERSION_OUT_OF_RANGE','Production schema must be version 28 or 29 before this migration.',{currentVersion,targetVersion});
