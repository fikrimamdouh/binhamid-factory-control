...
if(currentVersion<15||currentVersion>targetVersion)fail('SCHEMA_VERSION_OUT_OF_RANGE',`Production schema must be between versions 15 and ${targetVersion}.`,{currentVersion,targetVersion});
