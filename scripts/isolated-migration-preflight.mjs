...
const report={ok:true,currentVersion:Number(state.currentVersion),targetVersion:23,counts:state.counts,backup:{fileName:manifest.fileName,checksumSha256:manifest.checksumSha256,schemaVersion:Number(manifest.schemaVersion),encrypted:true},isolated:true};
