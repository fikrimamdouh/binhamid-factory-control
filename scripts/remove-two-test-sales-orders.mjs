...
const stop=(code,details={})=>{writeFileSync(output,JSON.stringify({ok:false,code,refs,...details},null,2)+'\n',{mode:0o600});console.error(`[test-sales-cleanup] ${code}`);process.exit(1);};
...
console.log(`[test-sales-cleanup] ${report.code}`);if(!ok)process.exit(1);
