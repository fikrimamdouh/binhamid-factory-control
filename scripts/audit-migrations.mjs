...
for(const file of files){
  ...
  if(version===21){for(const marker of ['device_enrollments','approve_device_enrollment','revoke_device_enrollment','DEVICE_APP_USER_NOT_ACTIVE','device_enrollment_approved'])if(!sql.includes(marker))errors.push(`${file}: missing ${marker}`);}
}
