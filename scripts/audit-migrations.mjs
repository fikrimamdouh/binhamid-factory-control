...
for(const file of files){
  ...
  if(version===16){for(const marker of ['financial_periods','credit_override_requests','unified_assets','asset_source_links','compliance_documents','custody_accounts','restore_test_runs','handover_acceptance_runs','control_credit_exposure'])if(!sql.includes(marker))errors.push(`${file}: missing ${marker}`);}
