...
for(const file of files){
  ...
  if(version===25){for(const marker of ['operation_events','idempotency_key','notification_outbox_dedupe_uidx','execute_unified_operation','transition_unified_operation','operation_transition_allowed','025_unified_operation_engine'])if(!sql.includes(marker))errors.push(`${file}: missing ${marker}`);}
}
