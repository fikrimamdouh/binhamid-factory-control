...
const keyboardReplacement=`export function accountantPreviewKeyboard(){
...
const homeReplacement=`export async function sendAccountantPreviewHome(message,identity,name='فيصل'){
...
const noticeReplacement=`export async function sendAccountantPreviewNotice(chatId){
