...
test('readiness requires schema 32 and reports accounting, governance, reset and persistent master gaps',async()=>{
  const readiness=await read('api/_lib/routes/system-runtime.js');
  assert.match(readiness,/LATEST_REQUIRED_VERSION=32/);
