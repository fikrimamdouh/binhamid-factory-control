...
test('Excel processing success is not converted into a processing failure when review or PDF delivery fails',()=>{
  ...
  assert.match(source,/result\?\.recognizedDaily[\s\S]*sendCumulativeDailyReports[\s\S]*return result;/);
