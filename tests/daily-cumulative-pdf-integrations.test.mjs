...
test('historical invoices are settled first in chronological FIFO order',()=>{
...
test('PDF HTML states cumulative formula and chronological FIFO boundary',()=>{
  ...
  assert.match(html,/أقدم الفواتير المستحقة أولًا وفق FIFO/);
