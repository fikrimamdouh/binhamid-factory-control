...
export default async function handler(req,res){
  ...
  try{const result=await sendManagerBrief();json(res,200,{ok:true,slot:'evening',...result});}catch(error){console.error('[evening brief]',error);json(res,500,{ok:false,error:error.message});}
}
