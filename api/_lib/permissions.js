...
export const ROLE_CAPABILITIES=Object.freeze({
  admin:['*'],
  manager:['dashboard.manager','daily_report.view','daily_report.approve','imports.read','imports.manage','costs.view','audit.view','governance.view','credit_override.approve','assets.view','compliance.view','handover.view','accounting.view','mix_design.view','mix_design.manage','mix_design.calculate','mix_design.approve','mix_material_prices.manage','workshop.view','workshop.create','workshop.update','workshop.manage','workshop.approve','workshop.close','workshop.diagnose','workshop.labor','workshop.test','workshop.parts.request','workshop.parts.manage','workshop.cost.view'],
  ...
  mechanic:['maintenance.manage','assets.view','workshop.view','workshop.create','workshop.update','workshop.diagnose','workshop.labor','workshop.test','workshop.parts.request'],
  fuel_operator:['fuel.import','assets.view'],
  hr:['costs.view','governance.view','compliance.manage','assets.view'],
  procurement:['maintenance.manage','assets.view','workshop.view','workshop.parts.request','workshop.parts.manage'],
