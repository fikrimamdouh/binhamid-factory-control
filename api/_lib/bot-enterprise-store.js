...
export const CATEGORY_LABEL={task:'مهمة',collection:'تحصيل',finance:'عملية مالية',inventory:'حركة مخزون',fuel:'تعبئة ديزل',hr:'موارد بشرية',quality:'جودة ورقابة',trip:'رحلة',purchase:'طلب شراء',customer:'عميل',production:'تقرير إنتاج',incident:'بلاغ تشغيلي'};
