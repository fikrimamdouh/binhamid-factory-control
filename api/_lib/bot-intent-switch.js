...
const START=/^(?:لو سمحت\s+|من فضلك\s+|بالله\s+)?(?:انا\s+)?(?:عاوز|عايز|محتاج|اريد|ابغى|أبغى|هات|هاتلي|هات لي|جيب|جيبلي|جيب لي|اعرض|وريني|افتح|ابدأ|ابدا|سجل|اعمل|نفذ|ابحث|إبحث|دور|دوّر|فتش|فتّش|طلع|اطلع|شوف)(?:\s|$)/i;
const SEARCH_ITEM=/عمود|كردان|قطعه|قطعة|فلتر|رولمان|بلي|سير|بطاري|كاوتش|كفر|اطار|إطار|خرطوم|هيدروليك|طلمب|مضخ|موتور|محرك|صمام|بلف|ترس|جربوكس|جير|كلتش|فرامل|كمبروسر|شركة|شركه|مصنع|مورد|وكيل|موزع|محل|ورشه|ورشة|اشتري|شراء|سعر|اسعار|أسعار|عرض سعر|عروض اسعار|عروض أسعار/i;
