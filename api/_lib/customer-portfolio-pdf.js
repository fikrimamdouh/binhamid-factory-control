...
function customerRows(type,analysis,state,analytics,ownershipAnalytics,reportDate){
  ...
  for(const candidate of reportCustomerCandidates(type,analytics?.rows||[],activityIndex.rows)){
    ...
    rows.push({
      ...
      sales:settlement.grossDue,paid:settlement.reportCollections,outstanding:settlement.finalDebt,
      previousBalance:settlement.previousBalance,previousCredit:settlement.previousCredit,previousNetBalance:settlement.previousNetBalance,grossDue:settlement.grossDue,reportSales:settlement.reportSales,reportCollections:settlement.reportCollections,paidCurrent:settlement.paidCurrent,paidPrevious:settlement.paidPrevious,finalBalance:settlement.finalDebt,
