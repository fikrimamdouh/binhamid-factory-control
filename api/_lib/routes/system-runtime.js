...
export const LATEST_REQUIRED_VERSION=32;
...
export const DATABASE_TABLES=[
  ...
  'chart_of_accounts','journal_entries','journal_entry_lines','telegram_update_receipts','master_data_import_runs','fuel_transactions'
];
