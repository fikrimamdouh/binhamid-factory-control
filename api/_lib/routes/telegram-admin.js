...
const commands={
  ...
  bn:[{command:'start',description:'স্মার্ট কর্মচারী সহকারী চালু করুন'},{command:'menu',description:'আপনার কাজের মেনু খুলুন'},{command:'attendance',description:'উপস্থিতি, প্রস্থান ও চালকের চলাচল'},{command:'tasks',description:'নিজের খোলা কাজ দেখুন'},{command:'reports',description:'প্রबंधन रिपोर्ट'},{command:'sales',description:'ব্লক ও কংক্রিট বিক্রয় আদেশ'},{command:'workshop',description:'ওয়ার্কশপ এবং মেকানিক মেনু'},{command:'suppliers',description:'সরবরাহকারী খুঁজুন ও কোটেশন চান'},{command:'gps',description:'ফ্লিট GPS অবস্থা'},{command:'status',description:'সিস্টেম সংযোগ ও সর্বশেষ সিঙ্ক'},{command:'whoami',description:'নিজের ভূমিকা ও অবস্থা দেখুন'}],
