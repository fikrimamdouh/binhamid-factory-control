...
export const envSpec=Object.freeze({
  ...
  OPENAI_API_KEY:{requiredFor:[],secret:true,description:'اختياري للصوت والذكاء الاصطناعي'},
  GOOGLE_PLACES_API_KEY:{requiredFor:[],secret:true,description:'اختياري لدليل الأعمال'},
  GPS_PROVIDER:{requiredFor:[],description:'مزود GPS'},
  ...
  PDF_API_URL:{requiredFor:[],description:'خدمة PDF الاختيارية'},
  PDF_API_KEY:{requiredFor:[],secret:true,description:'مفتاح خدمة PDF'},
...
export const readiness=()=>({
  ...
  backupConfigured:Boolean(config.supabaseDbUrl),
