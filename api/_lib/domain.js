...
export const ROLE_LABELS = {admin:'مدير النظام',manager:'مدير المصنع',accountant:'المحاسب',mechanic:'مسؤول الورشة',block_sales:'مبيعات البلوك',concrete_sales:'مبيعات الخرسانة',collector:'مسؤول التحصيل',pending:'غير معتمد'};
