...
export async function loadProjectedCumulativeDailyReport(analysis={},reportDate){
  ...
  return projectCumulativeDailyReport({storedSales:sales,dailySales:analysis?.sales||[],dailyCollections:analysis?.collections||[],reportDate,latestApprovedDate:batches?.[0]?.report_date||''});
}
