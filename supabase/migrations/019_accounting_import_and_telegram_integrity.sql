...
revoke all on function public.assert_journal_entry_balanced(uuid) from anon,authenticated;
revoke all on function public.post_daily_report_accounting(uuid,text) from anon,authenticated;
revoke all on function public.daily_report_accounting_trigger() from anon,authenticated;
revoke all on function public.transition_import_status(uuid,text,text,text,uuid,jsonb) from anon,authenticated;
revoke all on function public.claim_telegram_update(text,text) from anon,authenticated;
revoke all on function public.complete_telegram_update(text) from anon,authenticated;
revoke all on function public.fail_telegram_update(text,text,text,boolean) from anon,authenticated;
